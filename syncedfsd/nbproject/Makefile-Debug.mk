...
# C Compiler Flags
CFLAGS=-std=c99 -D_XOPEN_SOURCE=600 -Wall -pedantic
...
${OBJECTDIR}/protobuf/syncedfs.pb-c.o: protobuf/syncedfs.pb-c.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags libprotobuf-c`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/protobuf/syncedfs.pb-c.o protobuf/syncedfs.pb-c.c
...
${OBJECTDIR}/lib/get_num.o: lib/get_num.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags libprotobuf-c`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/get_num.o lib/get_num.c

${OBJECTDIR}/lib/error_functions.o: lib/error_functions.c 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags libprotobuf-c`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/error_functions.o lib/error_functions.c

${OBJECTDIR}/lib/inet_sockets.o: lib/inet_sockets.c 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags libprotobuf-c`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/inet_sockets.o lib/inet_sockets.c
...
${OBJECTDIR}/lib/alt_functions.o: lib/alt_functions.c 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags libprotobuf-c`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/alt_functions.o lib/alt_functions.c

${OBJECTDIR}/lib/read_line.o: lib/read_line.c 
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags libprotobuf-c`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/lib/read_line.o lib/read_line.c
