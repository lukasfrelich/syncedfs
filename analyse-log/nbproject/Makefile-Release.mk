...
${OBJECTDIR}/_ext/1260215813/server.o: ../syncedfs-daemon/server.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1260215813/server.o ../syncedfs-daemon/server.c
...
${OBJECTDIR}/_ext/1275677342/syncid.o: ../syncedfs-common/syncid.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1275677342
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275677342/syncid.o ../syncedfs-common/syncid.c
...
${OBJECTDIR}/_ext/1260215813/client.o: ../syncedfs-daemon/client.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1260215813
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1260215813/client.o ../syncedfs-daemon/client.c
...
${OBJECTDIR}/_ext/1260215813/config.o: ../syncedfs-daemon/config.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1260215813
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1260215813/config.o ../syncedfs-daemon/config.c
...
${OBJECTDIR}/_ext/1275677342/logging_functions.o: ../syncedfs-common/logging_functions.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1275677342
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275677342/logging_functions.o ../syncedfs-common/logging_functions.c

${OBJECTDIR}/_ext/1260215813/snapshot.o: ../syncedfs-daemon/snapshot.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1260215813
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1260215813/snapshot.o ../syncedfs-daemon/snapshot.c

${OBJECTDIR}/_ext/1260215813/optimization.o: ../syncedfs-daemon/optimization.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1260215813
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1260215813/optimization.o ../syncedfs-daemon/optimization.c
