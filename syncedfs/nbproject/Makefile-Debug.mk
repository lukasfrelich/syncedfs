...
${OBJECTDIR}/_ext/1275677342/message_functions.o: ../syncedfs-common/message_functions.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags fuse` `pkg-config --cflags libprotobuf-c` `pkg-config --cflags libconfig`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275677342/message_functions.o ../syncedfs-common/message_functions.c
...
${OBJECTDIR}/_ext/1275677342/config_functions.o: ../syncedfs-common/config_functions.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1275677342
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags fuse` `pkg-config --cflags libprotobuf-c` `pkg-config --cflags libconfig`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1275677342/config_functions.o ../syncedfs-common/config_functions.c
...
${OBJECTDIR}/_ext/988793768/become_daemon.o: ../syncedfs-common/lib/become_daemon.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/988793768
	${RM} $@.d
	$(COMPILE.c) -g `pkg-config --cflags fuse` `pkg-config --cflags libprotobuf-c` `pkg-config --cflags libconfig`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/988793768/become_daemon.o ../syncedfs-common/lib/become_daemon.c
